...
ac(nanohtml12, ["\n        ",nanohtml0,"\n        ",arguments[2],nanohtml1,"\n        ",nanohtml2,nanohtml3,"\n        Players: ",arguments[3],nanohtml4,"\n        Score: ",arguments[4],nanohtml5,nanohtml6,"\n\n        ",nanohtml7,nanohtml8,"\n        Players: ",arguments[5],nanohtml9,"\n        Score: ",arguments[6],nanohtml10,nanohtml11,"\n        \n        ",arguments[7],"\n        \n        ",arguments[8]," \n    "])
      return nanohtml12
            ...
            : `<strong>${currentPlayer(state).name}</strong> continues their turn with ${state.timeRemaining} seconds remaining<br />`,isCurrentPlayer(state) ? (function () {
      var ac = require('/Users/kylejacobson/projects/salad-bowl/node_modules/nanohtml/lib/append-child.js')

...
const newGame = state => {
    return  (function () {
      ...
      var nanohtml2 = document.createElement("form")
nanohtml2["onsubmit"] = arguments[0]
var nanohtml0 = document.createElement("input")
nanohtml0.setAttribute("id", "playerName")
nanohtml0.setAttribute("type", "text")
nanohtml0.setAttribute("placeholder", "your name")
nanohtml0.setAttribute("required", "required")
var nanohtml1 = document.createElement("button")
nanohtml1.setAttribute("type", "submit")
ac(nanohtml1, ["New game"])
ac(nanohtml2, ["\n        ",nanohtml0,"\n        ",nanohtml1,"\n    "])
      return nanohtml2
    }(handleNewGame))
}
...
var nanohtml3 = document.createElement("p")
var nanohtml0 = document.createElement("br")
var nanohtml1 = document.createElement("a")
nanohtml1.setAttribute("href", "?/games/" + arguments[0])
ac(nanohtml1, ["?/games/",arguments[1]])
var nanohtml2 = document.createElement("br")
ac(nanohtml3, ["Waiting on other players. ",nanohtml0,"\n            ",nanohtml1,nanohtml2,"\n            ",arguments[2],"\n        "])
var nanohtml4 = document.createElement("ul")
ac(nanohtml4, ["\n            ",arguments[3],"\n        "])
ac(nanohtml5, [nanohtml3,nanohtml4])
      return nanohtml5
    }(state.id,state.id,isAdmin(state.adminId) ? (function () {
      var ac = require('/Users/kylejacobson/projects/salad-bowl/node_modules/nanohtml/lib/append-child.js')
      var nanohtml0 = document.createElement("button")
nanohtml0["onclick"] = arguments[0]
ac(nanohtml0, ["Start game"])
      return nanohtml0
    }(handleStartGame)) : '',state.players.map((player) => {
                return (function () {
      var ac = require('/Users/kylejacobson/projects/salad-bowl/node_modules/nanohtml/lib/append-child.js')
